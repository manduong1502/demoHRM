      ...
      <aside className="sidebar">
        ...
        <ul className="sidebar-menu">
          <li className={activeView === 'view-dashboard' ? 'active' : ''}>
            <a href="#" onClick={(e) => { e.preventDefault(); setActiveView('view-dashboard'); }}>
          ...
          {checkHasPermission('employee:view') && (
            <li className={activeView === 'view-employees' ? 'active' : ''}>
              <a href="#" onClick={(e) => { e.preventDefault(); setActiveView('view-employees'); }}>
                <svg fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className={activeView === 'view-timesheet' ? 'active' : ''}>
            <a href="#" onClick={(e) => { e.preventDefault(); setActiveView('view-timesheet'); }}>
              <svg fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className={activeView === 'view-leaves' ? 'active' : ''}>
            <a href="#" onClick={(e) => { e.preventDefault(); setActiveView('view-leaves'); }}>
          ...
          <li className={activeView === 'view-salary' ? 'active' : ''}>
            <a href="#" onClick={(e) => { e.preventDefault(); setActiveView('view-salary'); }}>
              <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className={activeView === 'view-kpi' ? 'active' : ''}>
            <a href="#" onClick={(e) => { e.preventDefault(); setActiveView('view-kpi'); }}>
              <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className={activeView === 'view-reports' ? 'active' : ''}>
            <a href="#" onClick={(e) => { e.preventDefault(); setActiveView('view-reports'); }}>
              <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="main-wrapper">
        <header className="main-header">
          ...
          <div className="flex gap-sm">
            <button onClick={handleQuickCheckIn} className="btn btn-success">
              <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
              </svg>
              Check-In
            </button>
            <button onClick={handleQuickCheckOut} className="btn btn-primary">
              <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
